...
class m150111_174753_add_streets_tables extends Migration
{
  public function up()
  {
    ...
    $this->createTable('{{%streets}}', [
      ...
      'street_type_id' => Schema::TYPE_INTEGER . ' NOT NULL COMMENT \'Street type ID\'',
    ...
    $this->addForeignKey('FK_street_type', 'streets', 'street_type_id', 'streets_types', 'id', 'CASCADE', 'NO ACTION');
  }
